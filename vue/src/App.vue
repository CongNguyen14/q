<template>
  <div id="app" >
    ...
    <form @submit.stop.prevent id="stock-form">
            <input type="text" value="" placeholder="Search stock ..." v-model="stock" id="stock">
            <button @click="updateA(stock)"><i class="fa fa-search"></i></button>

    </form>
      <StockInfo v-if="this.company" :beta="beta" :stock="stock" :ceo="ceo" 
    ...
    <Table v-if="tableData" :theData="computedTableData" :config="config"></Table>  
     <h2 v-if="count==0">Stocks News</h2>
   <div class="body" id="body" v-if="count==0">
            ...
            <div class="cryptocurrencies">
              ...
              <div class="cryptocurrency">
                <a class="article-ccs" v-for="a in this.cryptocurrenciesPriceTop" :key="a.symbol" >
                  ...
                  <div v-bind:class="{percentsChange, increase:a.changesPercentage > 0, decrease:a.changesPercentage < 0}" >
                    {{a.changesPercentage}} %
                  </div>
                  <div class="price">
                    $ {{a.price.toFixed(4)}}
            ...
            <div class="cryptocurrencies">
              ...
              <div class="cryptocurrency">
                <a class="article-ccs" v-for="a in this.currenciesTop" :key="a.ticker" >
                  ...
                  <div v-bind:class="{percentsChange, increase:a.changes > 0, decrease:a.changes < 0}">
                    {{a.changes.toFixed(3)}} 
                  </div>
                  <div class="price">
                    $ {{(a.bid)}}
          ...
          <div class="cryptocurrencies">
              ...
              <div class="cryptocurrency">
                <a class="article-ccs" v-for="a in this.gainersTop" :key="a.ticker" >
                  ...
                  <div v-bind:class="{percentsChange, increase: true}">
          ...
          <div class="cryptocurrencies">
              ...
              <div class="cryptocurrency">
                <a class="article-ccs" v-for="a in this.losersTop" :key="a.ticker" >
                  ...
                  <div v-bind:class="{percentsChange, decrease: true}">
                    {{a.changesPercentage.replace(/[\)\()]/gi,"")}} 
                  </div>
                  <div class="price">
                    $ {{a.price}}
      ...
      <div>
           ...
           <a class="article-ccs-all" v-for="a in this.cryptocurrenciesPriceSortDown" :key="a.symbol" v-if="a.price && countPrice ==0 &&curTab==0" >
             <div><img :src="a.img" alt="" style="width:10%"></div>
            ...
            <div v-bind:class="{percentsChange, increase:a.changesPercentage > 0, decrease:a.changesPercentage < 0, notChange:a.change}" v-if="a.price">
              {{a.changesPercentage}} %
            </div>
            <div v-if="a.price" v-bind:class="{percentsChange, increase:a.change > 0, decrease:a.change < 0, notChange:a.change ==0}">
              {{a.change.toFixed(8)}}$
            </div>
          </a>

          <a class="article-ccs-all" v-for="a in this.cryptocurrenciesPriceSortUp" :key="a.symbol" v-if="a.price && countPrice > 0 && curTab==0" >
            <div ><img :src="a.img" alt="" style="width:10%"></div>
            <div class="ccs-symbol" v-if="a.price">
              {{a.symbol.replace("USD","")}}
            </div>
          ...
          <a class="article-ccs-all" v-for="a in this.cryptocurrenciesChangePerSortUp" :key="a.symbol" v-if="a.price && countChangePercent > 0 && curTab==1" >
            <div ><img :src="a.img" alt="" style="width:10%"></div>
            <div class="ccs-symbol" v-if="a.price">
              {{a.symbol.replace("USD","")}}
            </div>
          ...
          <a class="article-ccs-all" v-for="a in this.cryptocurrenciesChangePerSortDown" :key="a.symbol" v-if="a.price && countChangePercent == 0 && curTab ==1" >
            <div ><img :src="a.img" alt="" style="width:10%"></div>
            <div class="ccs-symbol" v-if="a.price">
              {{a.symbol.replace("USD","")}}
            </div>
          ...
          <a class="article-ccs-all" v-for="a in this.cryptocurrenciesSymbolSortUp" :key="a.symbol" v-if="a.price && countSymbol > 0 && curTab==3" >
            <div ><img :src="a.img" alt="" style="width:10%"></div>
            <div class="ccs-symbol" v-if="a.price">
              {{a.symbol.replace("USD","")}}
            </div>
          ...
          <a class="article-ccs-all" v-for="a in this.cryptocurrenciesSymbolSortDown" :key="a.symbol" v-if="a.price && countSymbol == 0 && curTab ==3" >
            <div ><img :src="a.img" alt="" style="width:10%"></div>
            <div class="ccs-symbol" v-if="a.price">
              {{a.symbol.replace("USD","")}}
            </div>
      ...
      <div class="cryptocurrencies" id="currenciesAll" v-if="count==2">
        ...
        <div class="cryptocurrency">
          ...
          <a class="article-ccs-all" v-for="a in this.currencies" :key="a.ticker" >
            <div><img :src="a.img" alt="" width="10%"></div>
            <div class="ccs-symbol" >
              {{a.ticker}}
            </div>
            <div class="price" >
            ...
            <div v-bind:class="{percentsChange, increase:a.changes > 0, decrease:a.changes < 0, notChange:a.changes ==0}">
...
export default {
  ...
  created () {
      ...
      axios.get(`https://financialmodelingprep.com/api/v3/stock_news?limit=100&apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
        .then(res=>{
          this.news = res.data
        ...
        axios.get(`https://financialmodelingprep.com/api/v3/quotes/crypto?apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
          .then(res =>{
          ...
          axios.get(`https://financialmodelingprep.com/api/v3/fx?apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
            .then(res =>{
        ...
        axios.get(`https://financialmodelingprep.com/api/v3/gainers?apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
          .then(res=>{
              this.gainers =res.data
              this.gainersTop = this.gainers.slice(0,5)
          })

           axios.get(`https://financialmodelingprep.com/api/v3/losers?apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
          .then(res=>{
  ...
  methods:{
    ...
    getTablePagination(stock) {
            axios.get(`https://financialmodelingprep.com/api/v3/income-statement/${stock}?period=quarter&limit=400&apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
                .then(({ data }) => {
                    this.tableData = data       
                })
        },
        getChartPie(stock){
            axios.get(`https://financialmodelingprep.com/api/v3/balance-sheet-statement/${stock}?period=quarter&limit=1&apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
                .then(res =>{
                    this.bss = res.data[0]
          ...
          getChart(stock) {
            axios.get(`https://financialmodelingprep.com/api/v3/historical-price-full/${stock}?timeseries=10000&apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
                .then(res => {
        ...
        getValueCompany(stock) {
            axios.get(`https://financialmodelingprep.com/api/v3/ratios-ttm/${stock}?apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
                .then(res => {
            ...
            getInfoStock(stock) {
            axios.get(`https://financialmodelingprep.com/api/v3/profile/${stock}?apikey=8f2b2385c78da72b1b4ac27c06b75dae`)
                .then(res => {                  
